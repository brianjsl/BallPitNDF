...
from src.modules.lndf_robot.models.conv_occupancy_net import (
...
class LocalNDF:
    def __init__(self, cfg: DictConfig):
        ...
        self.query_points = self._create_query_pts(
            self.query_point_cfg["type"], self.query_point_cfg["args"]
        )
        ...
        self.optimizer = self._create_optimizer(
            self.model, self.query_points, self.pose_optimizer_cfg, self.eval_dir
        )
    ...
    def _create_model(self, model_cfg: DictConfig):
        ...
        model_ckpt = osp.join(
            os.getcwd(), "src/modules/lndf_robot/ckpts", model_cfg["ckpt"]
        )
