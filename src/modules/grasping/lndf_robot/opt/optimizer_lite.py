...
from src.modules.grasping.lndf_robot.utils import util, torch_util, trimesh_util, torch3d_util
from src.modules.grasping.lndf_robot.utils.plotly_save import plot3d, multiplot
...
class OccNetOptimizer:
    ...
    def optimize_transform_implicit(self, shape_pts_world_np, viz_path='visualize',
        ...
        """
        Function to optimize the transformation of our query points, conditioned on
