...
import torch
from src.stations.setup_demo_diagram import BuildPouringDiagram
...
@hydra.main(config_path='src/config', config_name='demo')
def pouring_demo(cfg: DictConfig) -> bool:
    meshcat = StartMeshcat()

    diagram, visualizer = BuildPouringDiagram(meshcat, cfg)
